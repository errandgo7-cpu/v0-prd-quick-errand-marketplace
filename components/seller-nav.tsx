...
import { Home, Package, ShoppingCart, BarChart3, User, Menu } from "lucide-react"
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between gap-4">
        ...
        <Link href="/seller" className="flex items-center gap-2">
          ...
          <span className="rounded bg-[#10b981] px-2 py-0.5 text-xs font-semibold text-white">Seller</span>
        </Link>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem asChild>
                <Link href="/seller/profile">Profile Settings</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
